(() => {
  ...
  // Instagram shows "Following" or "Follow" button in the follower row.
  // If you follow them back there will be a "Following" / "Message" button.
  // If not, there will only be a "Follow" button.
  function detectFollowsBack(container) {
    ...
    for (const btn of allBtns) {
      ...
      // "following" or "message" means you already follow them back
      if (text === 'following' || text === 'message') return true;
      // "follow" (not following) means not following back
